...
public class generate_receipts extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        print1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                String pdfFileName = "paveways_receipt.pdf";
                printPageToPDF(contentView, pdfFileName);
    ...
    private void printPageToPDF(View contentView, String pdfFileName) {
        // Create a new document
        PdfDocument pdfDocument = new PdfDocument();

        // Create a page info with the desired page dimensions
        int pageWidth = contentView.getWidth();
        int pageHeight = contentView.getHeight();
        ...
        try {
            // Create the file to save the PDF
            File file = new File(getStorageDir("PDF"), pdfFileName);
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(generate_receipts.this);
            builder.setTitle("Success")
                    .setMessage("PDF File Generated Successfully. PDF saved at: " + file.getAbsolutePath())
                    //.setIcon(android.R.drawable.ic_dialog_alert)
                    .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                        public void onClick(DialogInterface dialog, int whichButton) {
                            Intent intent = new Intent(Intent.ACTION_VIEW);
    ...
    // Helper method to get the storage directory
    private File getStorageDir1(String dirName) {
